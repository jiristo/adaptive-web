...
export const ui = {
  cs: {
    ...
    emailSubmit: 'Dejte mi vědět',
    emailNote: 'Budeme tě informovat jako první.',
    ...
    navShop: 'Eshop',
    navLongevity: 'Dlouhověkost',
    longevityHref: '/preview/dlouhovekost/',
    appCortisolHref: '/preview/aplikace/kortizol/',
    appSummerHref: '/preview/aplikace/letni-pretizeni/',
    shopHref: '/preview/eshop/',
    navAbout: 'O nás',
    ...
    aboutCredentials: 'Fitness trenér · Polyvagální teorie · AI & datová věda',
    ...
    // Footer
    footerCopyright: '© 2026 Adaptive Studio',
    footerLocation: 'Zlín, Česká republika',
  },
  ...
  en: {
    ...
    emailNote: "You'll be the first to know.",
    ...
    navShop: 'Shop',
    navLongevity: 'Longevity',
    longevityHref: '/en/preview/dlouhovekost/',
    appCortisolHref: '/en/preview/aplikace/kortizol/',
    appSummerHref: '/en/preview/aplikace/summer-overload/',
    shopHref: '/en/preview/eshop/',
    navAbout: 'About Us',
    ...
    // Services
    servicesTag: 'WAYS TO WORK TOGETHER',
    ...
    // Footer
    footerCopyright: '© 2026 Adaptive Studio',
    footerLocation: 'Zlín, Czech Republic',
  },
} as const;
